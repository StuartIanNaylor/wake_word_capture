...
def trim(source_dir='./in', dest_dir='./out', start_length=1.0, end_length=1.0, min_pass_len=0.2, silence_percentage=0.05, tries=5, increment=2, min_silence_duration=0.05, fade_len=0.2):
